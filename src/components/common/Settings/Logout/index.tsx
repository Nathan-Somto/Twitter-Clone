...
function Logout({}: Props) {
  return (
    <div className="flex justify-between">
      <div>
      <h4 className="h4-medium font-semibold mb-2">Logout from Application</h4>
      <p className="subtle-normal dark:text-light2 opacity-80">By pressing the button you can logout of the application</p>
      </div>
      <Button size="icon" className="bg-red-700 flex-shrink-0">
        <svg
