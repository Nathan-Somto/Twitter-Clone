...
function TweetCard({
  ...
  const isUserTweet = useMemo(() => {
    (session as CustomSession)?.user?.id === _id;
  }, [_id, session]);
      ...
      <div className="flex flex-col items-center w-full gap-3">
        ...
        <div className="flex gap-2 w-full item-center">
          ...
          <div className="flex w-full flex-col">
            ...
            <p className="mt-2 md:base-regular whitespace-pre-line  small-regular dark:text-primaryWhite">
              {text}
            </p>
          </div>
        </div>
              ...
              {hasLiked ? (
                ...
                >
                  <path
                    ...
                    className="fill-[#e0245e]  group-hover:fill-[#e0245e] animate-scale-up "
                  />
                </svg>
              ) : (
                /* Heart Outline */
